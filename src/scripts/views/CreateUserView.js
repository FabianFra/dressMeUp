...
export default class CreateUserView extends Component {
    ...
    render = () => {
        const questions = [
            ...
            { id: '3', title: 'Welche Farben magst du?', type: 'MARTIAN_COLOR', storeAs: 'desirableColors'},
            { id: '4', title: 'Welche Farben magst du nicht?', type: 'MARTIAN_COLOR', storeAs: 'undesirableColors'},
        ];
